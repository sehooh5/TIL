...
<!--     0317 jung 첫번째 아이콘 -->
     <div class="items"  onclick="location.href='/backstreet/changeConsulting1?area_id=<%=areaId %>&serv_id=CS100001'">
     <img  src="resources/images/store_1.svg"width='80%'><br><br>
     <b>한식음식점</b>
       </div>
 <!--     0317 jung 두번째 아이콘 -->
       <div class="items"onclick= "location.href='/backstreet/changeConsulting1?area_id=<%=areaId %>&serv_id=CS100008'">
     <img src="resources/images/store_2.svg"width='80%'><br><br>
      <b>제과점</b>
       </div>
 <!--     0317 jung 세번째 아이콘 -->
       <div class="items"onclick="location.href='/backstreet/changeConsulting1?area_id=<%=areaId %>&serv_id=CS100009'">
     <img src="resources/images/store_3.svg"width='80%'><br><br>
      <b>커피 및 음료</b>
       </div>
 <!--     0317 jung 네번째 아이콘 -->
       <div class="items" onclick="location.href='/backstreet/changeConsulting1?area_id=<%=areaId %>&serv_id=CS100010'">
     <img src="resources/images/store_4.svg"width='80%'><br><br>
      <b>호프</b>
       </div>
 <!--     0317 jung 다섯번째 아이콘 -->
       <div class="items" onclick="location.href='/backstreet/changeConsulting1?area_id=<%=areaId %>&serv_id=CS200001'">
     <img src="resources/images/store_5.svg"width='80%'><br><br>
      <b>학원</b>
       </div>
 <!--     0317 jung 여섯번째 아이콘 -->
       <div class="items"  onclick="location.href='/backstreet/changeConsulting1?area_id=<%=areaId %>&serv_id=CS200009'">
     <img src="resources/images/store_6.svg"width='80%'><br><br>
      <b>숙박업</b>
       </div>       

    <!--     0317 jung 일곱번째 아이콘 -->
       <div class="items" onclick="location.href='/backstreet/changeConsulting1?area_id=<%=areaId %>&serv_id=CS200011'">
     <img src="resources/images/store_7.svg"width='80%'><br><br>
      <b>pc방</b>
       </div>       
    <!--     0317 jung 8번째 아이콘 -->
       <div class="items" onclick="location.href='/backstreet/changeConsulting1?area_id=<%=areaId %>&serv_id=CS200016'">
     <img src="resources/images/store_8.svg"width='80%'><br><br>
      <b>미용실</b>
       </div>       
    <!--     0317 jung 9번째 아이콘 -->
       <div class="items" onclick="location.href='/backstreet/changeConsulting1?area_id=<%=areaId %>&serv_id=CS300002'">
     <img src="resources/images/store_9.svg"width='80%'><br><br>
      <b>편의점</b>
       </div>  
    <!--     0317 jung 10번째 아이콘 -->
       <div class="items" onclick="location.href='/backstreet/changeConsulting1?area_id=<%=areaId %>&serv_id=CS300007'">
     <img src="resources/images/store_10.svg"width='80%'><br><br>
      <b>의류</b>
       </div>  
    <!--     0317 jung 11번째 아이콘 -->
       <div class="items" onclick="location.href='/backstreet/changeConsulting1?area_id=<%=areaId %>&serv_id=CS300008'">
     <img src="resources/images/store_11.svg"width='80%'><br><br>
      <b>패션용품</b>
       </div>       
    <!--     0317 jung 12번째 아이콘 -->
       <div class="items" onclick="location.href='/backstreet/changeConsulting1?area_id=<%=areaId %>&serv_id=CS300011'">
