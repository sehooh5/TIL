...
<script>
	var mymap = L.map('map').setView([37.566, 126.978], 16);
	...
	L.marker([37.566, 126.978]).addTo(mymap).bindPopup('<b>청진동 곱창골목</b><br><a href="/backstreet/consulting" target="_self">자세한 내용 확인</a>').openPopup();
