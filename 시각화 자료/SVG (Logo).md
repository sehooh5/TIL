...
- 단독적으로 생성 할때는 xmlns 속성을 꼭 주어야 하고

  HTML 내에 사용할때는 xmlns 속성을 생략해도 된다.

  ```html
  <svg width="180" height="200" xmlns="http://www.w3.org/2000/avg">
  ///svg 태그들 작성
  </svg>
  ```
...
<hr>
<img src="../images/cactus1.png" width="150">
<hr>
<img src="../images/cactus2.svg" width="150">
</body>
</html>
...
<hr>
<svg width="300px" height="500px" xmlns:xlink= "http://www.w3.org/1999/xlink">
  <image xlink:href="../images/duke.png" x="50" y="100" width="40" height="80" />
  <image xlink:href="../images/duke.png" x="100" y="50" width="40" height="80" />
  <image xlink:href="../images/duke.png" x="150" y="1" width="40" height="80" />
  <image xlink:href="../images/duke.png" x="150" y="300" width="40" height="80" />
  <image xlink:href="../images/duke.png" x="200" y="50" width="40" height="80" />
  <image xlink:href="../images/duke.png" x="250" y="100" width="40" height="80" />
</svg>
</body>
</html>
```
...
<svg width="300px" height="210px">
  <text x="110" y="30" font-size="1.5em" stroke="red" stroke-width="0.5">stroke="red"</text>
  ...
  <text x="110" y="120" font-size="1.5em" stroke="green" fill="none" >stroke="green"</text>
...
<svg width="300px" height="200px">
  ...
  <path d="M 10 10 L 290 190" stroke="black" fill="skyblue" />
</svg>
<hr>
<svg width="300px" height="200px">
  <!-- a angle: Move pen to (280,20); Draw a line to (10,190); Draw a line to (280,190) -->
  <path d="M 280,20 L 10,190 280,190" fill="skyblue" stroke="brown" stroke-width="2" />
</svg>
<hr>
<svg width="300px" height="200px">
  <!-- a angle: Move pen to (280,20); Draw a line to (10,190); Draw a line to (280,190) -->
  <path d="M 280,20 L 10,190 280,190Z" fill="skyblue" stroke="brown" stroke-width="2" />
</svg>
</body>
</html>
```
...
<html>
	...
	<body>
		...
		<svg>
			...
			<circle cx="320" cy="140" r="80" opacity="0.75" fill="blue"/>
		</svg>
	</body>
</html>
...
<html>
	...
	<body>
		...
		<script>
		//체이닝 방식 : 객체가 리턴되고 . 리턴되고 . 리턴되게끔 한 방식
...
<path
	...
	stroke="#eb6e4b" fill="none" stroke-width="6" stroke-linecap="round" />
...
<path
	...
	stroke="magenta" fill="none" stroke-width="6" stroke-linecap="round" />
</svg>
<hr>
<svg>
<path
...
#### exam22.html (이동, transform="translate")
...
#### exam23.html (회전, transform="rotate")
...
#### exam26.html (defs 정의, 선그라디언트 사용법)
...
#### exam27.html (g태그로 묶고 use 로 복사하여 사용)
...
<svg width="300px" height="300px">
  <circle cx="150" cy="150" r="10" fill="none" stroke="purple" stroke-width="2">
 	<!-- attributeName : 무엇을 애니메이션효과줄지, to : 크기 ~ 까지, dur : 시간, repeatCount : 반복수 -->
...
#### exam31.html (webfont 사용, 칼라 애니메이션)
...
<img src="my.svg">
<hr>
<img src="my.svg" width="100" height="100">
<hr>
<img src="my.svg" width="50">
</body>
</html>
```
